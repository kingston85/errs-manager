...
router.get('/:id/edit', ownedCase, async (req, res) => {
  ...
  res.render('documents/form', { title: `Edit — ${record.type_label}`, record, types: null, companies, chemicals, units: null, isNew: false, usedThisYear, attachments: attachmentsList, attachmentsBase: `/app/documents/${record.id}/attachments` });
});
